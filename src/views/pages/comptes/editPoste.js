...
export default function EditPoste({ ...others }) {
    ...
    const handleSubmit = (values, { setErrors, setStatus, setSubmitting }) => {
        ...
        if (values.newPassword != values.confirmNewPassword) {
            ...
            postServices.updatePost(values.email, values.numTel, gouv, values.delegation, values.newPassword, values.password, formData, user.id).then(
                () => {
