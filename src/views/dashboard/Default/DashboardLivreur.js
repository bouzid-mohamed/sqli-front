...
// project imports
import EarningCard from './EarningCardLivreur';
import PopularCard from './PopularCardLivreur';
import TotalOrderLineChartCard from './TotalOrderLineChartCardLivreur';
import TotalIncomeDarkCard from './TotalIncomeDarkCardLivreur';
import TotalIncomeLightCard from './TotalIncomeLightCardLivreur';
import TotalGrowthBarChart from './TotalGrowthBarChartLivreur';
                    ...
                    <Grid container spacing={gridSpacing}>
                        ...
                        <Grid item lg={4} md={12} sm={12} xs={12}>
                            <Grid container spacing={gridSpacing}>
                                ...
                                <Grid item sm={6} xs={12} md={6} lg={12}>
                                    <TotalIncomeLightCard isLoading={isLoading} nbrEnCours={nbrEnCours} />
                                </Grid>
                            </Grid>
                        </Grid>
                    </Grid>
